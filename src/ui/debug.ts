...
export function mountDebugTools(root: Element): Readonly<{ dispose(): void }> {
  ...
  panel.style.cssText = 'box-sizing:border-box;position:fixed;left:12px;top:52px;z-index:2;max-width:calc(100vw - 24px);max-height:calc(100vh - 64px);overflow:auto;padding:8px;background:#171914f2;color:#eee6d5;border:1px solid #74694e;border-radius:5px;font:13px/1.35 system-ui;pointer-events:auto';
